...
export default class DataEvents extends Vue {
  ...
  public viewItem(val: number) {
    const objectClass: any = val;
    this.$router.push({ name: 'dataTriggersForm', params: { objectClass } });
  }

  public addItem() {
    this.$router.push({ name: 'dataTriggersAdd' });
  }
}
